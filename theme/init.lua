...
theme.titlebar_maximized_button_normal_active= theme_path.."circle.svg"
theme.titlebar_maximized_button_focus_active= gears.color.recolor_image(theme_path.. "circle.svg", theme.sec)
